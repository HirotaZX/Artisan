...
namespace Artisan.IPC
{
    public static class RetainerInfo
    {
        ...
        public static bool AToolsEnabled
        {
            get
            {
                return AToolsInstalled && (DalamudReflector.TryGetDalamudPlugin("Allagan Tools", out var at, false, true) || DalamudReflector.TryGetDalamudPlugin("InventoryToolsCN", out var it, false, true)) && _IsInitialized != null && _IsInitialized.InvokeFunc();
            }
        }
